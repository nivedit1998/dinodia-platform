// Architecture: App Router surface src/app/installer/provision/provisionClient.tsx; composes the user journey for this route and delegates reusable data, validation and state work to shared modules.
'use client';
